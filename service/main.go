...
import (
	...
	"log"
	"reflect"
	elastic "gopkg.in/olivere/elastic.v3" // alias is 'elastic'
...
const (
	...
	DISTANCE = "10000km"
	// Needs to update
	PROJECT_ID = "around-186323"
	BT_INSTANCE = "around-post-186323"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://35.227.186.151:9200/"
	ENABLE_MEMCACHE = true
	//ENABLE_BIGTABLE = false
	REDIS_URL       = "redis-16659.c1.us-central1-2.gce.cloud.redislabs.com:16659"
	BUCKET_NAME = "post-images-186323"
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	var p = Post{
		//从username := claims.(jwt.MapClaims)["username"]取用户名，防止client假冒用户名
